...
import { register, login, logout, me, setCoverImage, setImage, toggleWatchHistory } from "../controllers/user.controller";
...
router.post("/watch-history/toggle", requireAuth, toggleWatchHistory); // POST => /api/users/watch-history/toggle
